...
LOCAL_SHARED_LIBRARIES := liblog libcutils libdl libhardware libutils
#################################################################
#GYROSCOPE
ifeq ($(BOARD_HAVE_GYRO),true)
LOCAL_SRC_FILES += gyro/GyroSensor.cpp
LOCAL_CFLAGS += -DGYRO_INSTALL_$(BOARD_GYRO_INSTALL)
else
LOCAL_CFLAGS += -DGYRO_NULL
endif #BOARD_HAVE_GYRO
#################################################################
