...
static struct iic_unit eCmdSetRateArray[] = {
  {
    .operate = 0x02, .addr = 0x20, .val = 0x90, .mask = 0xF0,   //ODR = 1250 HZ
  },
  {
...
void SensorHubOpcodeRegisterAccelerometer_sc7a20_ud710_2c11(void) {
  SensorHubOpcodeRegister("accelerometer_sc7a20_ud710_2c11", sensorInfoConfigArray, sSensorOpcode, eAccCaliDataArray, sizeof(eAccCaliDataArray));
  return;
}
