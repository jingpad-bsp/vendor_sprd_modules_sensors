...
void SensorHubOpcodeRegisterAccelerometer_bmi160(void) {
  SensorHubOpcodeRegister("accelerometer_bmi160", sensorInfoConfigArray, sSensorOpcode, eAccCaliDataArray, sizeof(eAccCaliDataArray));
  return;
}
