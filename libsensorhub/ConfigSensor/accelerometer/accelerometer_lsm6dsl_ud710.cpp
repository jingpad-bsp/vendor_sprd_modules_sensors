...
void SensorHubOpcodeRegisterAccelerometer_lsm6dsl_ud710(void) {
  SensorHubOpcodeRegister("accelerometer_lsm6dsl_ud710", sensorInfoConfigArray, sSensorOpcode, eAccCaliDataArray, sizeof(eAccCaliDataArray));
  return;
}
