...
void SensorHubOpcodeRegisterAccelerometer_bmi160_ud710_20c11(void) {
  SensorHubOpcodeRegister("accelerometer_bmi160_ud710_20c11",
			  sensorInfoConfigArray, sSensorOpcode,
			  eAccCaliDataArray, sizeof(eAccCaliDataArray));
  return;
}
