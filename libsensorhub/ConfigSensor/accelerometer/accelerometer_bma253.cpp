...
void SensorHubOpcodeRegisterAccelerometer_bma253(void) {
  SensorHubOpcodeRegister("accelerometer_bma253", sensorInfoConfigArray, sSensorOpcode, eAccCaliDataArray, sizeof(eAccCaliDataArray));
  return;
}
