...
static struct iic_unit eCmdInitArray[] = {
  {
    .operate = 0x02, .addr = 0x07, .val = 0x03, .mask = 0xFF,
  },
  {
    .operate = 0x02, .addr = 0x20, .val = 0x29, .mask = 0xFF,
  },
};

static struct iic_unit eCmdEnableArray[] = {
  {
    .operate = 0x02, .addr = 0x08, .val = 0x05, .mask = 0xFF,
  },
  {
    .operate = 0x02, .addr = 0x07, .val = 0x01, .mask = 0xFF,
  },
  {
...
static struct iic_unit eCmdCheckIdArray[] = {
  {
    .operate = 0x03, .addr = 0x3b, .val = 0x20, .mask = 0xF0,
  },
};
...
void SensorHubOpcodeRegisterAccelerometer_mc3416p(void) {
  SensorHubOpcodeRegister("accelerometer_mc3416p", sensorInfoConfigArray, sSensorOpcode, eAccCaliDataArray, sizeof(eAccCaliDataArray));
  return;
}
