...
static struct iic_unit eCmdInitArray[] = {
  {
    .operate = 0x02, .addr = 0x23, .val = 0x88, .mask = 0x88,    //bdu = 1, hr = 1
  },
  {
    .operate = 0x02, .addr = 0x23, .val = 0x20, .mask = 0x30,    //scale, 8g
  },
};

static struct iic_unit eCmdEnableArray[] = {
  {
    .operate = 0x02, .addr = 0x20, .val = 0x07, .mask = 0x07,    //3-axis enable
  },
};

static struct iic_unit eCmdDisableArray[] = {
  {
    .operate = 0x02, .addr = 0x20, .val = 0x00, .mask = 0x07,    //3-axis disable
  },
  {
    .operate = 0x02, .addr = 0x20, .val = 0x00, .mask = 0xF0,    //power off
  },
...
static struct iic_unit eCmdGetRawDataArray[] = {
  {
    .operate = 0x01, .addr = 0xA8, .val = 0x00, .mask = 0xF0,
  },
  {
    .operate = 0x01, .addr = 0xA9, .val = 0x00, .mask = 0xFF,
  },
  {
    .operate = 0x01, .addr = 0xAA, .val = 0x00, .mask = 0xF0,
  },
  {
    .operate = 0x01, .addr = 0xAB, .val = 0x00, .mask = 0xFF,
  },
  {
    .operate = 0x01, .addr = 0xAC, .val = 0x00, .mask = 0xF0,
  },
  {
    .operate = 0x01, .addr = 0xAD, .val = 0x00, .mask = 0xFF,
  },
};
...
static struct iic_unit eCmdGetStatusArray[] = {
  {
    .operate = 0x03, .addr = 0x27, .val = 0x08, .mask = 0x08,   //3-axis data ready
  },
};
...
static struct iic_unit eCmdSetRateArray[] = {
  {
    .operate = 0x02, .addr = 0x20, .val = 0x90, .mask = 0xF0,   //1.25k
  },
  {
    .operate = 0x02, .addr = 0x20, .val = 0x40, .mask = 0xF0,   //ODR = 50 HZ
  },
  {
    .operate = 0x02, .addr = 0x20, .val = 0x30, .mask = 0xF0,   //ODR = 25 HZ
  },
  {
    .operate = 0x02, .addr = 0x20, .val = 0x20, .mask = 0xF0,   //ODR = 10 HZ
  },
  {
    .operate = 0x02, .addr = 0x20, .val = 0x10, .mask = 0xF0,   //ODR = 1 HZ
  },
};
...
static struct iic_unit eCmdCheckIdArray[] = {
  {
    .operate = 0x03, .addr = 0x0F, .val = 0x11, .mask = 0xFF,   //chip ID check
  },
};
...
static sensor_info_t sensorInfoConfigArray[] = {
  {
    ...
    .ISR_Mode       = 0,
    .GPIO_ISR_Num   = 0,
    .Slave_Addr     = 0x30,        //?????PIN 1 SDO GND; 0x32 PIN 1 SDO VDD or VDDIO or float
    .Chip_Id        = 0x11,        //SC7A20 chip ID, reg 0x0F
    .Resolution     = 0.038326f,   //12 bit
    .Range          = 8,           //scale
    .Postion        = 4,           //default  djq
    .Vendor         = 0,
  },
};
...
void SensorHubOpcodeRegisterAccelerometer_sc7a20(void) {
  SensorHubOpcodeRegister("accelerometer_sc7a20", sensorInfoConfigArray, sSensorOpcode, eAccCaliDataArray, sizeof(eAccCaliDataArray));
  return;
}
