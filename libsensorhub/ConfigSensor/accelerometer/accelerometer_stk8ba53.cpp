...
static struct iic_unit eCmdInitArray[] = {
  {
    .operate = 0x02, .addr = 0x14, .val = 0xB6, .mask = 0xFF,
  },
  {
    .operate = 0x04, .addr = 0x00, .val = 0x00, .mask = 0x02,
  },
  {
    .operate = 0x02, .addr = 0x0F, .val = 0x08, .mask = 0x0F,
  },
  {
    .operate = 0x02, .addr = 0x10, .val = 0x0B, .mask = 0x0F,
  },
  {
    .operate = 0x02, .addr = 0x34, .val = 0x04, .mask = 0x04,
  },
};
...
static struct iic_unit eCmdDisableArray[] = {
  {
    .operate = 0x02, .addr = 0x11, .val = 0x80, .mask = 0x80,
  },
  {
    .operate = 0x04, .addr = 0x00, .val = 0x00, .mask = 0x14,
  },
...
static struct iic_unit eCmdSetRateArray[] = {
  {
    .operate = 0x02, .addr = 0x10, .val = 0x0B, .mask = 0x1F,
  },
  {
    .operate = 0x02, .addr = 0x10, .val = 0x0A, .mask = 0x1F,
  },
  {
    .operate = 0x02, .addr = 0x10, .val = 0x08, .mask = 0x1F,
  },
  {
    .operate = 0x02, .addr = 0x10, .val = 0x00, .mask = 0x1F,
  },
  {
...
static struct iic_unit eCmdCheckIdArray[] = {
  {
    .operate = 0x03, .addr = 0x00, .val = 0x87, .mask = 0xFF,
  },
};
...
void SensorHubOpcodeRegisterAccelerometer_stk8ba53(void) {
  SensorHubOpcodeRegister("accelerometer_stk8ba53", sensorInfoConfigArray, sSensorOpcode, eAccCaliDataArray, sizeof(eAccCaliDataArray));
  return;
}
