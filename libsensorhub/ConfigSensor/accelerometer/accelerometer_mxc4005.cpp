...
void SensorHubOpcodeRegisterAccelerometer_mxc4005(void) {
  SensorHubOpcodeRegister("accelerometer_mxc4005", sensorInfoConfigArray, sSensorOpcode, eAccCaliDataArray, sizeof(eAccCaliDataArray));
  return;
}