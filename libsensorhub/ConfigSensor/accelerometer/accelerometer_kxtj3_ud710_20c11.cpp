...
void SensorHubOpcodeRegisterAccelerometer_kxtj3_ud710_20c11(void) {
  SensorHubOpcodeRegister("accelerometer_kxtj3_ud710_20c11", sensorInfoConfigArray, sSensorOpcode, eAccCaliDataArray, sizeof(eAccCaliDataArray));
  return;
}
