...
void SensorHubOpcodeRegisterAccelerometer_lsm6dsl(void) {
  SensorHubOpcodeRegister("accelerometer_lsm6dsl", sensorInfoConfigArray, sSensorOpcode, eAccCaliDataArray, sizeof(eAccCaliDataArray));
  return;
}
