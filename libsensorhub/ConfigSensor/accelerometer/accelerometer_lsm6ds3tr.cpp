...
static struct iic_unit eCmdSetRateArray[] = {
  ...
  {
    .operate = 0x04, .addr = 0x00, .val = 0x00, .mask = 0x19,
  },
};
...
void SensorHubOpcodeRegisterAccelerometer_lsm6ds3tr(void) {
  SensorHubOpcodeRegister("accelerometer_lsm6ds3tr", sensorInfoConfigArray, sSensorOpcode, eAccCaliDataArray, sizeof(eAccCaliDataArray));
  return;
}
