...
void SensorHubOpcodeRegisterAccelerometer_icm20608(void) {
  SensorHubOpcodeRegister("accelerometer_icm20608", sensorInfoConfigArray, sSensorOpcode, eAccCaliDataArray, sizeof(eAccCaliDataArray));
  return;
}
