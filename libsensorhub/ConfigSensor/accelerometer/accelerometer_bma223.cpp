...
void SensorHubOpcodeRegisterAccelerometer_bma233(void) {
  SensorHubOpcodeRegister("accelerometer_bma233", sensorInfoConfigArray, sSensorOpcode, eAccCaliDataArray, sizeof(eAccCaliDataArray));
  return;
}
