...
void SensorHubOpcodeRegisterAccelerometer_mc3416(void) {
  SensorHubOpcodeRegister("accelerometer_mc3416", sensorInfoConfigArray, sSensorOpcode, eAccCaliDataArray, sizeof(eAccCaliDataArray));
  return;
}
