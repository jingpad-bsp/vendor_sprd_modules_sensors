...
void SensorHubOpcodeRegisterAccelerometer_qma6981(void) {
  SensorHubOpcodeRegister("accelerometer_qma6981", sensorInfoConfigArray, sSensorOpcode, eAccCaliDataArray, sizeof(eAccCaliDataArray));
  return;
}
