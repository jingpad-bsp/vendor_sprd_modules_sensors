...
static struct iic_unit eCmdEnableArray[] = {
  ...
  {
    .operate = 0x02, .addr = 0x1A, .val = 0x03, .mask = 0x07,
  },
};
...
static struct iic_unit eCmdSetRateArray[] = {
  ...
  {
    .operate = 0x04, .addr = 0x00, .val = 0x01, .mask = 0x64,
  },
};
...
void SensorHubOpcodeRegisterGyroscope_icm20600_l3_1c10(void) {
  SensorHubOpcodeRegister("gyroscope_icm20600_l3_1c10", sensorInfoConfigArray, sSensorOpcode, eGyroCaliDataArray, sizeof(eGyroCaliDataArray));
  return;
}
