...
void SensorHubOpcodeRegisterGyroscope_bmi160_9861s3(void) {
  SensorHubOpcodeRegister("gyroscope_bmi160_9861s3", sensorInfoConfigArray, sSensorOpcode, eGyroCaliDataArray, sizeof(eGyroCaliDataArray));
  return;
}
