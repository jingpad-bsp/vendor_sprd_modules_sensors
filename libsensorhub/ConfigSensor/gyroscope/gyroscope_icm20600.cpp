...
void SensorHubOpcodeRegisterGyroscope_icm20600(void) {
  SensorHubOpcodeRegister("gyroscope_icm20600", sensorInfoConfigArray, sSensorOpcode, eGyroCaliDataArray, sizeof(eGyroCaliDataArray));
  return;
}
