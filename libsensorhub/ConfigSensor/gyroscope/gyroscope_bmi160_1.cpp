...
void SensorHubOpcodeRegisterGyroscope_bmi160_1(void) {
  SensorHubOpcodeRegister("gyroscope_bmi160_1", sensorInfoConfigArray, sSensorOpcode, eGyroCaliDataArray, sizeof(eGyroCaliDataArray));
  return;
}
