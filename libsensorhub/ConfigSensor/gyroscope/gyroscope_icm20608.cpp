...
void SensorHubOpcodeRegisterGyroscope_icm20608(void) {
  SensorHubOpcodeRegister("gyroscope_icm20608", sensorInfoConfigArray, sSensorOpcode, eGyroCaliDataArray, sizeof(eGyroCaliDataArray));
  return;
}
