...
static struct iic_unit eCmdInitArray[] = {
  {
    .operate = 0x02, .addr = 0x11, .val = 0x0C, .mask = 0x0F,
  },
  {
...
static struct iic_unit eCmdSetRateArray[] = {
  ...
  {
    .operate = 0x04, .addr = 0x00, .val = 0x05, .mask = 0xC8,
  },
};
...
void SensorHubOpcodeRegisterGyroscope_lsm6dsl_ud710(void) {
  SensorHubOpcodeRegister("gyroscope_lsm6dsl_ud710", sensorInfoConfigArray, sSensorOpcode, eGyroCaliDataArray, sizeof(eGyroCaliDataArray));
  return;
}
