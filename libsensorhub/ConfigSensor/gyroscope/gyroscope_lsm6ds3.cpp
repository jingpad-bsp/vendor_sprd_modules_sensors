...
void SensorHubOpcodeRegisterGyroscope_lsm6ds3(void) {
  SensorHubOpcodeRegister("gyroscope_lsm6ds3", sensorInfoConfigArray, sSensorOpcode, eGyroCaliDataArray, sizeof(eGyroCaliDataArray));
  return;
}
