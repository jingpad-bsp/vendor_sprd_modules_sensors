...
void SensorHubOpcodeRegisterGyroscope_lsm6dsl(void) {
  SensorHubOpcodeRegister("gyroscope_lsm6dsl", sensorInfoConfigArray, sSensorOpcode, eGyroCaliDataArray, sizeof(eGyroCaliDataArray));
  return;
}
