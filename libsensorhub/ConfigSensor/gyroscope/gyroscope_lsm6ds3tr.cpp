...
static struct iic_unit eCmdInitArray[] = {
  {
   ...
   {
    .operate = 0x02, .addr = 0x12, .val = 0x44, .mask = 0x44,
  },
};
...
static struct iic_unit eCmdEnableArray[] = {
  ...
  {
    .operate = 0x04, .addr = 0x00, .val = 0x00, .mask = 0xF0,
  },
...
static struct iic_unit eCmdSetRateArray[] = {
  ...
  {
    .operate = 0x04, .addr = 0x00, .val = 0x00, .mask = 0x50,
  },
};
...
void SensorHubOpcodeRegisterGyroscope_lsm6ds3tr(void) {
  SensorHubOpcodeRegister("gyroscope_lsm6ds3tr", sensorInfoConfigArray, sSensorOpcode, eGyroCaliDataArray, sizeof(eGyroCaliDataArray));
  return;
}
