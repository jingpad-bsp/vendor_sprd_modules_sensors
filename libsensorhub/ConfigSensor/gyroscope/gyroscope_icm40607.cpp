...
static struct iic_unit eCmdEnableArray[] = {
  {
    .operate = 0x02, .addr = 0x4E, .val = 0x0C, .mask = 0x0C,
  },
  {
    .operate = 0x04, .addr = 0x00, .val = 0x00, .mask = 0x0A,
  },
  {
    .operate = 0x02, .addr = 0x4F, .val = 0x08, .mask = 0xFF,//set fs 2000dps,odr 100Hz
  },
//  {
//    .operate = 0x02, .addr = 0x52, .val = 0x00, .mask = 0x0F,//set bw odr/2
//  },
};

static struct iic_unit eCmdDisableArray[] = {
  {
    .operate = 0x02, .addr = 0x4E, .val = 0x00, .mask = 0x0C,
  },
  {
    .operate = 0x04, .addr = 0x00, .val = 0x00, .mask = 0x0A,
  },
...
static struct iic_unit eCmdSetRateArray[] = {
  {
    .operate = 0x02, .addr = 0x4F, .val = 0x08, .mask = 0x0F,//odr 100Hz
  },
  {
    .operate = 0x02, .addr = 0x4F, .val = 0x09, .mask = 0x0F,//odr 50Hz
  },
  {
    .operate = 0x02, .addr = 0x4F, .val = 0x0A, .mask = 0x0F,//odr 25Hz
  },
  {
    .operate = 0x02, .addr = 0x4F, .val = 0x0B, .mask = 0x0F,//odr 12.5Hz
  },
  {
...
void SensorHubOpcodeRegisterGyroscope_icm40607(void) {
  SensorHubOpcodeRegister("gyroscope_icm40607", sensorInfoConfigArray,
   sSensorOpcode, eGyroCaliDataArray, sizeof(eGyroCaliDataArray));
  return;
}
