...
void SensorHubOpcodeRegisterPressure_bmp280(void) {
    SensorHubOpcodeRegister("pressure_bmp280", sensorInfoConfigArray, sSensorOpcode, (uint8_t*)&berometer_offset,sizeof(float));
   return;
}
