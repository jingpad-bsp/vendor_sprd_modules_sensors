...
void SensorHubOpcodeRegisterMagnetic_af8133i(void) {
  SensorHubOpcodeRegister("magnetic_af8133i", sensorInfoConfigArray, sSensorOpcode, (uint8_t*)eMagSoftCaliArray, sizeof(eMagSoftCaliArray));
  return;
}
