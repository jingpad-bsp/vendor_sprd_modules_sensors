...
void SensorHubOpcodeRegisterMagnetic_qmc6983mm(void) {
  SensorHubOpcodeRegister("magnetic_qmc6983mm", sensorInfoConfigArray, sSensorOpcode, (uint8_t*)eMagSoftCaliArray, sizeof(eMagSoftCaliArray));
  return;
}