...
void SensorHubOpcodeRegisterMagnetic_akm09911c(void) {
  SensorHubOpcodeRegister("magnetic_akm09911c", sensorInfoConfigArray, sSensorOpcode, (uint8_t*)eMagSoftCaliArray, sizeof(eMagSoftCaliArray));
  return;
}