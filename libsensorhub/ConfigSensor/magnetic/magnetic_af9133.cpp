...
void SensorHubOpcodeRegisterMagnetic_af9133(void) {
  SensorHubOpcodeRegister("magnetic_af9133", sensorInfoConfigArray, sSensorOpcode, (uint8_t*)eMagSoftCaliArray, sizeof(eMagSoftCaliArray));
  return;
}
