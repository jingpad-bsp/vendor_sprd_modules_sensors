...
void SensorHubOpcodeRegisterMagnetic_mmc3630(void) {
  SensorHubOpcodeRegister("magnetic_mmc3630", sensorInfoConfigArray, sSensorOpcode, (uint8_t*)eMagSoftCaliArray, sizeof(eMagSoftCaliArray));
  return;
}