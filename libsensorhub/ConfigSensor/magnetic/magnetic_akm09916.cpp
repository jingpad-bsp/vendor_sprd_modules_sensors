...
void SensorHubOpcodeRegisterMagnetic_akm09916(void) {
  SensorHubOpcodeRegister("magnetic_akm09916", sensorInfoConfigArray, sSensorOpcode, (uint8_t*)eMagSoftCaliArray, sizeof(eMagSoftCaliArray));
  return;
}
