...
void SensorHubOpcodeRegisterMagnetic_mmc3630_9861s3(void) {
  SensorHubOpcodeRegister("magnetic_mmc3630_9861s3", sensorInfoConfigArray, sSensorOpcode, (uint8_t*)eMagSoftCaliArray, sizeof(eMagSoftCaliArray));
  return;
}