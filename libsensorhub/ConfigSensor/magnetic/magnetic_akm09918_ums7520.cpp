...
void SensorHubOpcodeRegisterMagnetic_akm09918(void) {
  SensorHubOpcodeRegister("magnetic_akm09918", sensorInfoConfigArray, sSensorOpcode, (uint8_t*)eMagSoftCaliArray, sizeof(eMagSoftCaliArray));
  return;
}
