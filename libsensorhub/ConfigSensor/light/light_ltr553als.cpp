...
static struct iic_unit eCmdInitArray[] = {
  ...
  {
    .operate = 0x02, .addr = 0x85, .val = 0x33, .mask = 0xFF,
  },
  {
...
static struct iic_unit eCmdEnableArray[] = {
  {
    .operate = 0x02, .addr = 0x80, .val = 0x0D, .mask = 0xFF,
  },
};
...
static struct iic_unit eCmdSetRateArray[] = {
  {
    .operate = 0x02, .addr = 0x85, .val = 0x23, .mask = 0xFF,
  },
  {
    .operate = 0x02, .addr = 0x85, .val = 0x23, .mask = 0xFF,
  },
...
void SensorHubOpcodeRegisterLight_ltr553als(void) {
  SensorHubOpcodeRegister("light_ltr553als", sensorInfoConfigArray, sSensorOpcode, (uint8_t*)eLightCaliArray, sizeof(eLightCaliArray));
  return;
}
