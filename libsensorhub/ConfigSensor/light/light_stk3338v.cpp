...
void SensorHubOpcodeRegisterLight_stk3338v(void) {
  SensorHubOpcodeRegister("light_stk3338v", sensorInfoConfigArray, sSensorOpcode, (uint8_t*)eLightCaliArray, sizeof(eLightCaliArray));
  return;
}
