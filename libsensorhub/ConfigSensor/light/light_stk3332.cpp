...
static struct iic_unit eCmdInitArray[] = {
	...
	{
	  .operate = 0x02, .addr = 0x02, .val = 0x31, .mask = 0xFF,
	},
	{
...
void SensorHubOpcodeRegisterLight_stk3332(void) {
  SensorHubOpcodeRegister("light_stk3332", sensorInfoConfigArray, sSensorOpcode, (uint8_t*)eLightCaliArray, sizeof(eLightCaliArray));
  return;
}
