...
static struct iic_unit eCmdGetRawDataArray[] = {
  ...
  {
    .operate = 0x01, .addr = 0x49, .val = 0x00, .mask = 0xFF,
  },
};
...
void SensorHubOpcodeRegisterLight_rpr0521(void) {
  SensorHubOpcodeRegister("light_rpr0521", sensorInfoConfigArray, sSensorOpcode, (uint8_t*)eLightCaliArray, sizeof(eLightCaliArray));
  return;
}
