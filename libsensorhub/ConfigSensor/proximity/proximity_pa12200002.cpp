...
void SensorHubOpcodeRegisterProximity_pa12200002(void) {
  SensorHubOpcodeRegister("proximity_pa12200002", sensorInfoConfigArray, sSensorOpcode, (uint8_t*)eProxCaliArray, sizeof(eProxCaliArray));
  return;
}