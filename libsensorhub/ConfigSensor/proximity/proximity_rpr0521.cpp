...
void SensorHubOpcodeRegisterProximity_rpr0521(void) {
  SensorHubOpcodeRegister("proximity_rpr0521", sensorInfoConfigArray, sSensorOpcode, (uint8_t*)eProxCaliArray, sizeof(eProxCaliArray));
  return;
}
