...
void SensorHubOpcodeRegisterProximity_ltr553als(void) {
  SensorHubOpcodeRegister("proximity_ltr553als", sensorInfoConfigArray, sSensorOpcode, (uint8_t*)eProxCaliArray, sizeof(eProxCaliArray));
  return;
}
