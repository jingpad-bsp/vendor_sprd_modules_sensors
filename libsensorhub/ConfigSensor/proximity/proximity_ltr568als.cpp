...
static struct iic_unit eCmdEnableArray[] = {
  {
    .operate = 0x02, .addr = 0x81, .val = 0x12, .mask = 0xFF,
  },
  {
...
static struct iic_unit eCmdDisableArray[] = {
  {
    .operate = 0x02, .addr = 0x81, .val = 0x10, .mask = 0xFF,
  },
};

static struct iic_unit eCmdGetRawDataArray[] = {
  {
    .operate = 0x01, .addr = 0x92, .val = 0x00, .mask = 0xFF,
  },
  {
    .operate = 0x01, .addr = 0x93, .val = 0x00, .mask = 0xFF,
  },
};
...
static struct iic_unit eCmdGetStatusArray[] = {
  {
    .operate = 0x01, .addr = 0x91, .val = 0x01, .mask = 0x01,
  },
};
...
static struct iic_unit eCmdSetRateArray[] = {
  {
    // ltr568 measure rate 6.125ms
    .operate = 0x02, .addr = 0x84, .val = 0x00, .mask = 0x07,
  },
  {
    // ltr568 measure rate 12.5ms
    .operate = 0x02, .addr = 0x84, .val = 0x01, .mask = 0x07,
  },
  {
    // ltr568 measure rate 25ms
    .operate = 0x02, .addr = 0x84, .val = 0x02, .mask = 0x07,
  },
  {
    // ltr568 measure rate 50ms
    .operate = 0x02, .addr = 0x84, .val = 0x03, .mask = 0x07,
  },
  {
    // ltr568 measure rate 100ms
    .operate = 0x02, .addr = 0x84, .val = 0x04, .mask = 0x07,
  },
  {
...
void SensorHubOpcodeRegisterProximity_ltr568als(void) {
  SensorHubOpcodeRegister("proximity_ltr568als", sensorInfoConfigArray, sSensorOpcode, (uint8_t*)eProxCaliArray, sizeof(eProxCaliArray));
  return;
}
