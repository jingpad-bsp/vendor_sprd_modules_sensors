...
static struct iic_unit eCmdEnableArray[] = {
  ...
  {
    .operate = 0x02, .addr = 0x84, .val = 0x08, .mask = 0x0F,
  },
  {
...
static struct iic_unit eCmdGetStatusArray[] = {
  {
    .operate = 0x01, .addr = 0x8C, .val = 0x01, .mask = 0x01,
  },
};
...
static struct iic_unit eCmdSetRateArray[] = {
  {
    // ltr553 measure rate 50ms
    .operate = 0x02, .addr = 0x84, .val = 0x00, .mask = 0x0F,
  },
  {
    // ltr553 measure rate 50ms
    .operate = 0x02, .addr = 0x84, .val = 0x00, .mask = 0x0F,
  ...
  {
    // ltr553 measure rate 100ms
    .operate = 0x02, .addr = 0x84, .val = 0x02, .mask = 0x0F,
  },
  {
    // ltr553 measure rate 100ms
    .operate = 0x02, .addr = 0x84, .val = 0x02, .mask = 0x0F,
...
void SensorHubOpcodeRegisterProximity_ltr553iwhale2(void) {
  SensorHubOpcodeRegister("proximity_ltr553iwhale2", sensorInfoConfigArray, sSensorOpcode, (uint8_t*)eProxCaliArray, sizeof(eProxCaliArray));
  return;
}
