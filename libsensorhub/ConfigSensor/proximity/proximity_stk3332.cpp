...
static struct iic_unit eCmdInitArray[] = {
	...
	{
	  .operate = 0x02, .addr = 0x03, .val = 0xA0, .mask = 0xFF,
	},
	{
	...
	{
	  .operate = 0x02, .addr = 0x4F, .val = 0x40, .mask = 0xFF,
	},
	{
...
void SensorHubOpcodeRegisterProximity_stk3332(void) {
  SensorHubOpcodeRegister("proximity_stk3332", sensorInfoConfigArray, sSensorOpcode, (uint8_t*)eProxCaliArray, sizeof(eProxCaliArray));
  return;
}
