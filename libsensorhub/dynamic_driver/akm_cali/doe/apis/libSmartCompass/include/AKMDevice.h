/******************************************************************************
 *
 *  $Id: AKMDevice.h 273 2014-08-11 03:02:38Z yamada.rj $
 *
 * -- Copyright Notice --
 *
...
#define I32MUL(x, y) ((int32_akm)(x) * (int32_akm)(y))
#define UI32MUL(x, y) ((uint32_akm)(x) * (uint32_akm)(y))
#else
...
typedef int32_t  int32_akm;
typedef uint32_t uint32_akm;
...
typedef union _int32_akmvec { // Three-dimensional vector constructed of signed 32 bits fixed point numbers
    struct {
        int32_akm x;
        int32_akm y;
        int32_akm z;
