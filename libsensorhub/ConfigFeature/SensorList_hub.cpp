...
#include "sensors/SensorTypePrivate.h"

#include "SensorList.h"

#ifdef SENSORHUB_UMS512
#define SensorMaxDelay 320000
#else
#define SensorMaxDelay 200000
#endif
...
static struct sensor_t sSensorList[] = {
        ...
        {.name =       "Shake",
         ...
         .fifoReservedEventCount = 0,
         .fifoMaxEventCount =   0,
         .stringType =         SENSOR_STRING_TYPE_SPRD_SHAKE,
         .requiredPermission = 0,
         .maxDelay =           0,
        ...
        {.name =       "Twist",
         ...
         .fifoReservedEventCount = 0,
         .fifoMaxEventCount =   0,
         .stringType =         SENSOR_STRING_TYPE_SPRD_TWIST,
         .requiredPermission = 0,
         .maxDelay =           0,
         .flags = SENSOR_FLAG_SPECIAL_REPORTING_MODE,
         .reserved =          {}
...
#if defined(SENSORHUB_WITH_ACC_AND_GYRO_AND_MAG) || defined(SENSORHUB_WITH_ACC_AND_MAG)
...
#endif  /* SENSORHUB_WITH_ACC_AND_GYRO_AND_MAG || SENSORHUB_WITH_ACC_AND_MAG */
        ...
        {.name =       "Front Camera",
         ...
         .fifoReservedEventCount = 0,
         .fifoMaxEventCount =   0,
         .stringType =         SENSOR_STRING_TYPE_SPRD_FRONT_CAMERA,
         .requiredPermission = 0,
         .maxDelay =           0,
         .flags = SENSOR_FLAG_SPECIAL_REPORTING_MODE,
         .reserved =          {}
        ...
        {.name =       "Rear Camera",
         ...
         .fifoReservedEventCount = 0,
         .fifoMaxEventCount =   0,
         .stringType =         SENSOR_STRING_TYPE_SPRD_REAR_CAMERA,
         .requiredPermission = 0,
         .maxDelay =           0,
         .flags = SENSOR_FLAG_SPECIAL_REPORTING_MODE,
         .reserved =          {}
        ...
        {.name =       "Tap",
         ...
         .fifoReservedEventCount = 0,
         .fifoMaxEventCount =   0,
         .stringType =         SENSOR_STRING_TYPE_SPRD_TAP,
         .requiredPermission = 0,
         .maxDelay =           0,
         .flags = SENSOR_FLAG_SPECIAL_REPORTING_MODE,
         .reserved =          {}
        ...
        {.name =       "Flip",
         ...
         .fifoReservedEventCount = 0,
         .fifoMaxEventCount =   0,
         .stringType =         SENSOR_STRING_TYPE_SPRD_FLIP,
         .requiredPermission = 0,
         .maxDelay =           0,
         .flags = SENSOR_FLAG_SPECIAL_REPORTING_MODE,
         .reserved =          {}
        ...
        {.name =       "Face up & down",
         ...
         .fifoReservedEventCount = 0,
         .fifoMaxEventCount =   0,
         .stringType =         SENSOR_STRING_TYPE_SPRD_FACE_UP_DOWN,
         .requiredPermission = 0,
         .maxDelay =           0,
         .flags = SENSOR_FLAG_ON_CHANGE_MODE,
         .reserved =          {}
        ...
        {.name =       "Context awareness",
         ...
         .fifoReservedEventCount = 0,
         .fifoMaxEventCount =   0,
         .stringType =        SENSOR_STRING_TYPE_SPRD_CONTEXT_AWARENESS,
         .requiredPermission = 0,
         .maxDelay =           0,
         .flags = SENSOR_FLAG_ON_CHANGE_MODE,
         .reserved =          {}
        ...
        {.name =       "Pocket mode",
         ...
         .fifoReservedEventCount = 0,
         .fifoMaxEventCount =   0,
         .stringType =         SENSOR_STRING_TYPE_SPRD_POCKET_MODE,
         .requiredPermission = 0,
         .maxDelay =           0,
         .flags = SENSOR_FLAG_ON_CHANGE_MODE,
         .reserved =          {}
        ...
        {.name =       "Hand up",
         ...
         .fifoReservedEventCount = 0,
         .fifoMaxEventCount =   0,
         .stringType =         SENSOR_STRING_TYPE_SPRD_HAND_UP,
         .requiredPermission = 0,
         .maxDelay =           0,
         .flags = SENSOR_FLAG_SPECIAL_REPORTING_MODE,
         .reserved =          {}
        ...
        {.name =       "Hand down",
         ...
         .fifoReservedEventCount = 0,
         .fifoMaxEventCount =   0,
         .stringType =         SENSOR_STRING_TYPE_SPRD_HAND_DOWN,
         .requiredPermission = 0,
         .maxDelay =           0,
         .flags = SENSOR_FLAG_SPECIAL_REPORTING_MODE,
         .reserved =          {}
        ...
        {.name =       "Media Flip (WAKE_UP)",
         ...
         .fifoReservedEventCount = 0,
         .fifoMaxEventCount =   0,
         .stringType =         SENSOR_STRING_TYPE_SPRD_MEDIA_FLIP,
         .requiredPermission = 0,
         .maxDelay =           0,
         .flags = SENSOR_FLAG_SPECIAL_REPORTING_MODE | SENSOR_FLAG_WAKE_UP,
         .reserved =          {}
